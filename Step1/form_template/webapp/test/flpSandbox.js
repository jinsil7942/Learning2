		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Learning Area",
									"targetURL": "#comgsitmfioriformtemplate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comgsitmfioriformtemplate-display": {
								"semanticObject": "comgsitmfioriformtemplate",
								"action": "display",
								"description": "Learning Test Area",
								"title": "Learning Area",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.gsitm.fiori.formtemplate",
									"url": sap.ui.require.toUrl("com/gsitm/fiori/formtemplate")
								}
							}
						}
					}
